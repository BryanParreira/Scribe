...
enum SettingsItem: String, CaseIterable, Identifiable {
    ...
    var summary: String {
        switch self {
        case .enableGlobally: return "Turn Jot on or off everywhere without quitting."
        case .fastMode: return "Skip screenshot context for faster suggestions."
        case .openAtLogin: return "Start Jot automatically when you log in."
        ...
        case .resetAllSettings: return "Restore every Jot setting to its original default."
        ...
        case .length: return "How many words Jot aims for per suggestion."
        case .name: return "What Jot should call you."
        ...
        case .toggleTabby: return "A global hotkey that turns Jot on or off."
        case .disabledApps: return "Apps where Jot never autocompletes."
        ...
        case .checkForUpdates: return "See if a newer Jot is available."
        case .support: return "Support the Jot project."
        case .githubRepository: return "Browse the source code and issues."
        case .wiki: return "Documentation and the contributor guide."
        case .acknowledgements: return "Third-party packages Jot ships with."
        case .uninstall: return "Remove Jot and its data from this Mac."
        }
    }
