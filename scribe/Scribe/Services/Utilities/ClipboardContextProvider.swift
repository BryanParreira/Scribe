...
/// Reads the current pasteboard only when Cotabby is about to build a prompt.
///
/// Clipboard contents are highly sensitive and change outside Jot's control, so this service does
