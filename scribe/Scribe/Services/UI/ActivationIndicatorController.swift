...
/// File overview:
/// Owns the tiny non-activating panel that marks supported inputs with Jot's icon near
...
final class ActivationIndicatorController {
    ...
    /// Places Jot's icon just outside the text area's left edge. When the field is flush against
