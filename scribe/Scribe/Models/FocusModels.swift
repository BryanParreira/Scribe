...
///
/// These are the concrete Accessibility capabilities Jot needs before it can safely assist a field.
...
struct FocusSnapshot: Equatable {
    ...
    ///
    /// Opening Jot's menu bar window can briefly make Cotabby the focused app. Treating Jot's own
...
/// need a stable application identity that does not immediately collapse to Jot's own process.
